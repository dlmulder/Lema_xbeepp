...
${OBJECTDIR}/SerialPort.o: SerialPort.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SerialPort.o SerialPort.cpp

${OBJECTDIR}/Xbee.o: Xbee.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Xbee.o Xbee.cpp

${OBJECTDIR}/XbeeAddress.o: XbeeAddress.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeAddress.o XbeeAddress.cpp

${OBJECTDIR}/XbeeCommand.o: XbeeCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeCommand.o XbeeCommand.cpp

${OBJECTDIR}/XbeeCommandException.o: XbeeCommandException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeCommandException.o XbeeCommandException.cpp

${OBJECTDIR}/XbeeCommandResponse.o: XbeeCommandResponse.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeCommandResponse.o XbeeCommandResponse.cpp

${OBJECTDIR}/XbeeCommandResponseImpl.o: XbeeCommandResponseImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeCommandResponseImpl.o XbeeCommandResponseImpl.cpp

${OBJECTDIR}/XbeeException.o: XbeeException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeException.o XbeeException.cpp

${OBJECTDIR}/XbeeFrame.o: XbeeFrame.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeFrame.o XbeeFrame.cpp

${OBJECTDIR}/XbeeFrameCommand.o: XbeeFrameCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeFrameCommand.o XbeeFrameCommand.cpp

${OBJECTDIR}/XbeeFrameCommandResponse.o: XbeeFrameCommandResponse.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeFrameCommandResponse.o XbeeFrameCommandResponse.cpp

${OBJECTDIR}/XbeeFrameDataSample.o: XbeeFrameDataSample.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeFrameDataSample.o XbeeFrameDataSample.cpp

${OBJECTDIR}/XbeeFrameDiscovery.o: XbeeFrameDiscovery.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeFrameDiscovery.o XbeeFrameDiscovery.cpp

${OBJECTDIR}/XbeeFrameRemoteCommand.o: XbeeFrameRemoteCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeFrameRemoteCommand.o XbeeFrameRemoteCommand.cpp

${OBJECTDIR}/XbeeFrameRemoteCommandResponse.o: XbeeFrameRemoteCommandResponse.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeFrameRemoteCommandResponse.o XbeeFrameRemoteCommandResponse.cpp

${OBJECTDIR}/XbeeLocal.o: XbeeLocal.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeLocal.o XbeeLocal.cpp

${OBJECTDIR}/XbeeLogger.o: XbeeLogger.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeLogger.o XbeeLogger.cpp

${OBJECTDIR}/XbeePort.o: XbeePort.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeePort.o XbeePort.cpp

${OBJECTDIR}/XbeeRemote.o: XbeeRemote.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XbeeRemote.o XbeeRemote.cpp
